<?php include "res/themetop.php" ?>
        ...
        <ul class="collection with-header">
          ...
          <li class="collection-item"><a cless="collection-link" href="#">Having and Giving</a></li>
          <li class="collection-item"><a class="collection-link" href="#">Asking Questions</a></li>
          <li class="collection-item"><a class="collection-link" href="#">Talking about Weather</a></li>
        </ul>
